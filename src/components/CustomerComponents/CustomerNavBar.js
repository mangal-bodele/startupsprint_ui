      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="/customer/show" activeClassName="active">Document show</NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="/customer/guarantor" activeClassName="active">Add Guarantor</NavLink>
            </li>
            <li className="nav-item">
