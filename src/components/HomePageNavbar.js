    ...
    return (
        <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#37517e' }}>
            <div className="container-fluid">
                <NavLink className="navbar-brand text-white" to="/home">StartUpSprint</NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link text-white" activeClassName="active" aria-current="page" to="/staff">AddStaff</NavLink>
                        </li>

                        <li className="nav-item">
                            <NavLink className="nav-link text-white" activeClassName="active" aria-current="page" to="/show">ShowStaff</NavLink>
                        </li>
                      
                        <li className="nav-item dropdown">
                            <NavLink className="nav-link dropdown-toggle text-white" activeClassName="active" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Roles</NavLink>
